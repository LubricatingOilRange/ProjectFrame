...
public class RxFlowCreateUtil {
    ...
    public static void empty() {
        Flowable.empty().subscribe(new FlowableSubscriber<Object>() {
            ...
            public void onNext(Object o) {
                Logger.i("empty：" + "onNext");
            }

            @Override
            public void onError(Throwable t) {
                Logger.i("empty：" + "onError");
            }

            @Override
            public void onComplete() {
                Logger.i("empty：" + "onComplete");
            }
        });
    }
    ...
    public static void error() {
        Flowable.error(new Callable<Throwable>() {
            ...
            @Override
            public void onError(Throwable t) {
                Logger.i("empty：" + "onError-" + t.getMessage());
            }
