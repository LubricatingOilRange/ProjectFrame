package com.frame.projectframe.ui.view.custom;
...
public class ClearEditText extends AppCompatEditText implements OnFocusChangeListener {
    ...
    private void init(Context context) {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = ContextCompat.getDrawable(context,
                    R.drawable.ic_clear);
        }
        //设置drawable大小
        if (mClearDrawable != null) {
            mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth() / 3,
                    mClearDrawable.getIntrinsicHeight() / 3);
        }
        // 默认设置隐藏图标
    ...
    public void setType(int t) {
        type = t;
        switch (type) {
            case TYPE_NONE://普通 12135546
                spanSetting = new int[0];
                break;
            case TYPE_BANK://银行  1231 4564 7897 8987
                spanSetting = new int[]{4, 9, 14, 19};
                break;
            case TYPE_MOBILE://手机 159 0053 8989
